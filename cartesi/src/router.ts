 ...
 * Configured via CARTESI_AUTHORIZED_SENDERS environment variable.
 */
const AUTHORIZED_SUBMITTERS = new Set<string>(
  (process.env.CARTESI_AUTHORIZED_SENDERS || '')
    .split(',')
...
export class Router {
   ...
   * Format: "type/param1/value1/param2/value2" or JSON
   */
